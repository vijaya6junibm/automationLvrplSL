...
*** Test Cases ***
TC_005
    [Documentation]  EPLFlashStoreLoadSyncService with existing zipcode and shipnode combination in extn_flash_store table with operation Delete
    ...
    Dictionary Should Contain Key     ${response.json()}     ZipCode
         ...
         log  ${Ship_Node}
         Set Test Message    Record is deleted