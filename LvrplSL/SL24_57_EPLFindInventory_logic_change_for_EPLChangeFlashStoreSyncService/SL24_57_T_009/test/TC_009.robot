...
*** Test Cases ***
TC_009
    [Documentation]  EPLFlashStoreLoadSyncService with existing zipcode and shipnode combination and distance 0 in extnFlashStore table
    ...
    Dictionary Should Contain Key     ${response.json()}     ZipCode
         ...
         log  ${Ship_Node}
         Set Test Message    Record updated with Distance calculated