...
*** Test Cases ***
Single Item Safety Factor XML received from SAP without mandatory attributes
    [Documentation]    An exception should be raised and logged into exception console.
