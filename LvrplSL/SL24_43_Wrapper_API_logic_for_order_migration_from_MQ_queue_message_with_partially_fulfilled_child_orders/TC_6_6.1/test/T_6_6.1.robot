...
*** Test Cases ***
Check Release of migration order T_6_6.1
    [Documentation]  Check Release of migration order
    ...
    ${timestamp} =    Get Current Date    result_format=%Y%m%d-%H%M
         ...
         Set Test Message   Order should get create successfully in V10 and Publish outbound message to XD/ECC