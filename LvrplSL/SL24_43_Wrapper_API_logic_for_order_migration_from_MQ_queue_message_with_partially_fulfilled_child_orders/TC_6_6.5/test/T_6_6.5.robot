...
*** Test Cases ***
Shortage from XD/EWM T_6_6.5
    [Documentation]     Shortage from XD/EWM
    ...
    ${timestamp} =    Get Current Date    result_format=%Y%m%d-%H%M
         ...
         Set Test Message  Release of order will be Backordered from Node , Order line/s will be moved in backordered