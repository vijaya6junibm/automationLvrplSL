...
*** Test Cases ***
Check Split - child order creation T_6_6.2
    [Documentation]  Check Split - child order creation
    ...
    ${timestamp} =    Get Current Date    result_format=%Y%m%d-%H%M
         ...
         Set Test Message   Order should get create successfully in V10 and Publish outbound message to SOMS