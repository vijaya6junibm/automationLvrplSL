...
*** Test Cases ***
Multiple order lines where a line in backordered status with 'Split' Hold and all child orders of a line cancelled and another line is in backordered status and rest delivered status T_2_2.6
    [Documentation]  Multiple order lines where a line in backordered status with 'Split' Hold and all child orders  of a line cancelled and another line is in backordered status and rest delivered status
