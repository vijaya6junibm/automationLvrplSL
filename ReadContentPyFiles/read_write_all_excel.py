...
def schedule_input_file1(order_no,Order_Header_Key):
    ...
    print(result)
    with open('input/scheduleOrder.xml', 'w', newline='') as fd:
        fd.write(result)
        return result

def release_input_file1(order_no,Order_Header_Key):
    inner_template = string.Template(
...
def somsns_input_file1(order_no, ItemID):
        inner_template = string.Template(
...
def getOrderDetails_input_file1(order_no,Order_Header_Key):
    inner_template = string.Template(
